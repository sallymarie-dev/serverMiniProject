...
let snacksStorage = [
  ...
  { id: randomUUID(), name: "Juice", price: 2.59, tags: ["Hawaiian Punch", "thirst quincher"] },
  { id: randomUUID(), name: "PopTarts", price: 2.59, tags: ["chocolate", "breakfast snack"] },
...
app.post("/snacks", (req, res) => {
  ...
  if (price === undefined || typeof price !== "number")
    return res.status(400).json({ error: "Snack price is required and must be a number" });

  // Creating new snacks
  const newSnack = { id: randomUUID(), name, price, tags: Array.isArray(tags) ? tags : [] };
